...
<br>
<input type="submit" name="make" value="Make Folder" class="btn btn-primary"></button>
<input type="submit" name="del" value="Remove Folder" class="btn btn-primary"></button>
&nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp
<input type="submit" name="rname" value="Rename File" class="btn btn-primary"></button>
<input type="submit" name="cpy" value="Copy File" class="btn btn-primary"></button>
</form>
